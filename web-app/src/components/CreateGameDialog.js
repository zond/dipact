...
{/* Zond: the below works for non-private,but should disable IF private and all are disabled, but somehow it doesn't work... Can you take a look?
I actually think it's because "anonymous" is checked by default when private is off - it should be greyed out but not checked (now it looks like Anonymous is forced open) */}
