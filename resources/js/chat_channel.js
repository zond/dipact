        ...
        <React.Fragment>
              ...
              <span style={{ display: "flex" }}>
                ...
                this.props.channel.Properties.Members.length ? (
                  <NationAvatarGroup
                    ...
                    nations={this.props.channel.Properties.Members}
                  />
                ) : (
                  <NationAvatarGroup
                    game={this.props.game}
          ...
          >
            {this.state.messages.map((message, idx) => {
              const selfish =
                this.member && this.member.Nation === message.Properties.Sender;
              return (
                <React.Fragment key={message.Properties.ID}>
                  {message.phase &&
                  (idx == 0 ||
                    message.phase.Properties.PhaseOrdinal !=
                      this.state.messages[idx - 1].phase.Properties
                        .PhaseOrdinal) ? (
                    <div
                  ...
                  this.newAfter < Date.parse(message.Properties.CreatedAt) &&
                  (idx == 0 ||
                    this.newAfter >=
                      Date.parse(
                        this.state.messages[idx - 1].Properties.CreatedAt
                      )) ? (
                    <div
                      className={helpers.scopedClass(`
												justify-content: center;
            ...
            !this.props.channel.Properties.Members.find((m) => {
              ...
              <div style={{
                ...
                <MaterialUI.Typography id="desktopOnlyInput" style={{marginRight: "56px"}} variant="caption">Ctrl + Enter to send</MaterialUI.Typography>
              </div>
            ) : (
              ""
            )}
