  ...
  resetValidators() {
    this.validators = [
      (props) => {
        if (
          props.LastYear != 0 &&
          props.LastYear < this.state.variant.Properties.Start.Year + 1
        ) {
          return (
      ...
      this.setState((state, props) => {
        ...
        if (ev.target.type == "checkbox") {
          if (propertyName == "Private") {
            state.newGameProperties["MinReliability"] = ev.target.checked
              ? 0
              : Math.min(
                  10,
    ...
    this.validators.push((properties) => {
      ...
      if (properties[name] != 0) {
        if (opts.max && opts.max < properties[name]) {
          return name + " must be lower than or equal to " + opts.max + ".";
        }
        if (opts.min && opts.min > properties[name]) {
          return (
            name + " must be 0, or greater than or equal to " + opts.min + "."
          );
        }
      }
      return null;
      ...
      <React.Fragment>
        ...
        >
          ...
          <div style={{ maxWidth: "920px", marginTop: "72px" }}>
            <div style={{ margin: "auto", width: "calc(100% - 32px)" }}>
              <div
                id="step1"
              ...
              >
                ...
                <img
                  ...
                  style={{ paddingBottom: "4px", maxHeight: "300px" }}
                />
                <MaterialUI.Typography
                  variant="body2"
                ...
                <MaterialUI.Typography
                  style={{ paddingBottom: "16px", overflowWrap: "break-word" }}
                  variant="body1"
                >
