          ...
          [
            ...
            (match) => {
              const serializedState = JSON.parse(
                pako.inflate(atob(decodeURIComponent(match[2])), {
                  to: "string",
                })
              );
              ...
              this.setState({
                ...
                activePhase: newPhases.find((phase) => {
                  return (
                    phase.Properties.PhaseOrdinal == serializedState.activePhase
                  );
                }),
                phases: newPhases,
              });
          ...
          >
            <MaterialUI.Toolbar>
              ...
              {!this.state.laboratoryMode && this.state.activePhase ? (
               ...
               !this.state.laboratoryMode ?
                <MaterialUI.Box key="curr-spacer" width="100%"></MaterialUI.Box>
                : ""
              )}
              { this.state.activePhase &&
          ...
          <MaterialUI.Snackbar
            ...
            message={[
              ...
              this.state.phaseMessages.map((m) => {
                return (
                  <MaterialUI.Typography key={m}>{m}</MaterialUI.Typography>
                );
              })
            )}
            action={
