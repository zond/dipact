						...
						return (
							<li key={"nation_" + nation}>
								<ul style={{"paddingLeft":"0px"}}>
									...
									<MaterialUI.Tooltip title="Confirmed their orders"> 
									<MaterialUI.SvgIcon >
									...
									<MaterialUI.Tooltip title="Wants a draw">
									...
									<MaterialUI.Tooltip title="Did not send orders">
									 <MaterialUI.SvgIcon style={{ paddingLeft:"8px", color: "#b71c1c" }}>
