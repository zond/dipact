						...
						return (
							<li key={"nation_" + nation}>
								<ul style={{"paddingLeft":"0px"}}>
									...
									<MaterialUI.Tooltip className={helpers.scopedClass(
									(phaseState.Properties.ReadyToResolve
								? ""
								: "display: none;"))} title="Confirmed their orders"> 
								...
								? ""
								: "display: none;"))} title="Wants a draw">
									<MaterialUI.SvgIcon color="primary" style={{paddingLeft:"8px"}}>
								...
								? ""
								: "display: none;"))} title="Did not send orders">
									 <MaterialUI.SvgIcon  color="primary"
