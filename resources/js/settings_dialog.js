                      ...
                      .Properties.Nations.map((nation, index) => {
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              <Color
                                ...
                                value={
                                  Globals.colorOverrides.variants[this.state.newColorOverrideVariant][nation] &&
                          ...
                          {/*TODO: Below is the "delete" button. This should have an onClick that deletes this variant and reloads the <color> element to the default colour*/}
                            ...
                            { Globals.colorOverrides.variants[this.state.newColorOverrideVariant][nation] &&
                                  Globals.contrastColors[index] !==
                                    Globals.colorOverrides.variants[this.state.newColorOverrideVariant][nation] ? <div style={{color:"#281A1A"}}>{helpers.createIcon("\ue872")}</div> : ""}
