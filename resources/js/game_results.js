				...
				<MaterialUI.DialogContent style={{ paddingBottom: "0px" }}>
					...
					<MaterialUI.List>
						{this.state.gameResult
							? helpers
									.decoratedSort(
										this.props.variant.Properties.Nations,
										nation => {
											return this.state.gameResult.Properties.Scores.find(
												s => {
										...
										(a, b) => {
											if (a.dec.Score > b.dec.Score) {
												return -1;
											} else if (
												a.dec.Score < b.dec.Score
											) {
												return 1;
											} else if (a.dec.SCs > b.dec.SCs) {
												return -1;
											} else if (a.dec.SCs < b.dec.SCs) {
												return 1;
											}
