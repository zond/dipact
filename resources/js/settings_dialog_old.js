    ...
    return (
      ...
      >
        ...
        {this.state.userConfig ? (
          <React.Fragment>
          	<div style={{ marginTop: "56px", padding: "0px 16px", display:"flex", flexDirection:"column"}}>
            ...
            <div width="100%">
              ...
              <MaterialUI.FormControlLabel
              	style={{width:"100%", maxWidth:"920px", paddingLeft:"0px"}}
              ...
              (window.Wrapper && window.Wrapper.startFCM) ? (
                Globals.messaging.started ? (
                  ...
                  <p style={{ marginTop: "2px" }}>
                    <MaterialUI.Typography variant="caption">
                      Notifications disabled [Error: notification system did not
                      start]
                    </MaterialUI.Typography>
                  </p>
                )
            ...
            <MaterialUI.FormControlLabel
              control={
                <MaterialUI.Switch
                  checked={this.state.userConfig.Properties.MailConfig.Enabled}
                  onChange={(ev) => {
                    ev.persist();
                    this.setState((state, props) => {
                      state = Object.assign({}, state);
            ...
            />
             <MaterialUI.Typography variant="subtitle2" style={{color: "rgba(40, 26, 26, 0.56)",  marginTop: "16px", padding: "16px 0px"}}>
            Colours
            </MaterialUI.Typography>
                    ...
                    if (parts.length == 1) {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Color
                            value={parts[1]}
                            onSelect={this.newColorSetter(idx, parts[0] + "/")}
                          />
                          <MaterialUI.ListItemSecondaryAction>
                            <MaterialUI.IconButton
                              edge="end"
            ...
            {console.log(this)}
            <div className={helpers.scopedClass("display: flex;")}>
              <MaterialUI.Select
              ...
              {this.state.newColorOverrideType == "position" ? (
                <React.Fragment>
                  ...
                  >
                    ...
                    <MaterialUI.Input
                      ...
                      inputProps={{
                        min: 0,
                        max: Globals.colorOverrides.positions.length,
                      }}
                      style={{
                        backgroundColor:
                      ...
                      value={this.state.newColorOverridePosition}
                      onChange={(ev) => {
                        let newValue = ev.target.value;
                        if (newValue != "") {
                          newValue = Number.parseInt(newValue);
            ...
            <MaterialUI.Button onClick={this.addColorOverride} color="primary">
              Add color override
            </MaterialUI.Button>
            </div>
          </React.Fragment>
