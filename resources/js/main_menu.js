			        ...
			        <MaterialUI.ClickAwayListener onClickAway={this.closeDrawer}>
         				<div onClick={this.closeDrawer}>
         					<MaterialUI.List component="nav">
         						...
         						<MaterialUI.ListItem button gamelistkey="1" urlkey="my_started_games_url" onClick={this.renderGameList}>
         							<MaterialUI.ListItemText primary="My started games" />
         						</MaterialUI.ListItem>
         						<MaterialUI.ListItem button gamelistkeyey="2" urlkey="my_staging_games_url" onClick={this.renderGameList}>
         							<MaterialUI.ListItemText primary="My staging games" />
         						</MaterialUI.ListItem>
         						<MaterialUI.ListItem button gamelistkey="3" urlkey="my_finished_games_url" onClick={this.renderGameList}>
         							<MaterialUI.ListItemText primary="My finished games" />
         						</MaterialUI.ListItem>
         						<MaterialUI.ListItem button gamelistkey="4" urlkey="open_games_url" onClick={this.renderGameList}>
         							<MaterialUI.ListItemText primary="Open games" />
         						</MaterialUI.ListItem>
         						<MaterialUI.ListItem button gamelistkey="5" urlkey="started_games_url" onClick={this.renderGameList}>
         							<MaterialUI.ListItemText primary="Started games" />
         						</MaterialUI.ListItem>
         						<MaterialUI.ListItem button gamelistkey="6" urlkey="finished_games_url" onClick={this.renderGameList}>
