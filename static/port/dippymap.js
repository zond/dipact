...
import { addBox, addArrow, addUnit, addCross } from "chart.js";
import $ from "jquery";

export default function dippyMap(container) {
  var that = this;
  var el = null;
  ...
  that.addOrder = function (order, color, opts = {}) {
    if (order[1] == "Hold") {
      ...
      addUnit("unit" + order[2], order[0], color, false, true, "#orders", opts);
