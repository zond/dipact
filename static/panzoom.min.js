...
}e=g[c]={exports:{}};d[c][0].call(e.exports,function(a){return f(d[c][1][a]||a)},e,e.exports,a,d,g,b)}return g[c].exports}for(var l="function"==typeof require&&require,c=0;c<b.length;c++)f(b[c]);return f}return a}()({1:[function(a,d,g){function b(a,b){function d(a,b){if(u.getScreenCTM){var n=u.getScreenCTM(),c=n.d,e=n.f;N.x=a*n.a-n.e;N.y=b*c-e}else N.x=a,N.y=b;return N}function g(){var a,b=0,c=0;if(a=ta()){b=a.left;c=a.top;var e=a.right-a.left;a=a.bottom-a.top}else a=q.getBoundingClientRect(),e=a.width,
a=a.height;var f=u.getBBox();if(0!==f.width&&0!==f.height){var d=Math.min(e/f.width,a/f.height);h.x=-(f.left+f.width/2)*d+e/2+b;h.y=-(f.top+f.height/2)*d+a/2+c;h.scale=d}}function l(){return{x:h.x,y:h.y}}function r(a,b){h.x=a;h.y=b;A();K("pan");fa()}function A(){var a=ta();if(a){var b=!1;var c=u.getBBox();var e=c.left*h.scale+h.x,f=c.top*h.scale+h.y;var d=c.width*h.scale+e;c=c.height*h.scale+f;d=a.left-d;0<d&&(h.x+=d,b=!0);d=a.right-e;0>d&&(h.x+=d,b=!0);d=a.top-c;0<d&&(h.y+=d,b=!0);d=a.bottom-f;0>
d&&(h.y+=d,b=!0);return b}}function ta(){if(O){if("boolean"===typeof O){var a=q.getBoundingClientRect(),b=a.width;a=a.height;return{left:b*P,top:a*P,right:b*(1-P),bottom:a*(1-P)}}return O}}function fa(){ha=!0;Q=window.requestAnimationFrame(Ma)}function ua(a,c,f){if(e(a)||e(c)||e(f))throw Error("zoom requires valid numbers");var n=h.scale*f;if(n<L){if(h.scale===L)return;f=L/h.scale}if(n>R){if(h.scale===R)return;f=R/h.scale}a=d(a,c);h.x=a.x-f*(a.x-h.x);h.y=a.y-f*(a.y-h.y);O&&1===P&&1===L?(h.scale*=
f,A()):A()||(h.scale*=f);if(!ia&&(ia=!0,K("zoom"),b.onZoom))b.onZoom();fa()}function ja(a,b,c){ua(a,b,c/h.scale)}function t(a,b,c){if(c){ka&&ka.cancel();var n=0,e=0;ka=v({x:0,y:0},{x:a,y:b},{step:function(a){r(h.x+(a.x-n),h.y+(a.y-e));n=a.x;e=a.y}})}else r(h.x+a,h.y+b)}function Na(a,b){X();r(a,b)}function va(){q.addEventListener("mousedown",wa,{passive:!1});q.addEventListener("dblclick",xa,{passive:!1});q.addEventListener("touchstart",ya,{passive:!1});q.addEventListener("keydown",za,{passive:!1});
p.addWheelListener(q,Y,{passive:!1});fa()}function Aa(){p.removeWheelListener(q,Y);q.removeEventListener("mousedown",wa);q.removeEventListener("keydown",za);q.removeEventListener("dblclick",xa);q.removeEventListener("touchstart",ya);Q&&(window.cancelAnimationFrame(Q),Q=0);B.cancel();Ba();Ca();la.release();ma()}function Ma(){ha&&(ha=!1,u.applyTransform(h),K("transform"),Q=0)}function za(a){var b=0,c=0,n=0;if(38===a.keyCode)c=1;else if(40===a.keyCode)c=-1;else if(37===a.keyCode)b=1;else if(39===a.keyCode)b=
-1;else if(189===a.keyCode||109===a.keyCode)n=1;else if(187===a.keyCode||107===a.keyCode)n=-1;if(!Oa(a,b,c,n)){if(b||c)onKeyDefault.is_passive||a.preventDefault(),a.defaultPrevented||(onKeyDefault.is_passive=!0),a.stopPropagation(),a=q.getBoundingClientRect(),a=Math.min(a.width,a.height),t(.05*a*b,.05*a*c);n&&(b=Da(100*n),C?c=S():(c=q.getBoundingClientRect(),c={x:c.width/2,y:c.height/2}),a=c,Z(a.x,a.y,b))}}function ya(a){na(a);1===a.touches.length?(oa=a=D(a.touches[0]),a=d(a.x,a.y),x=a.x,y=a.y,B.cancel(),
Ea()):2===a.touches.length&&(pa=Fa(a.touches[0],a.touches[1]),T=!0,Ea())}function na(a){if(!b.onTouch||b.onTouch(a))a.stopPropagation(),na.is_passive||a.preventDefault(),a.defaultPrevented||(na.is_passive=!0)}function qa(a){if(!b.onDoubleClick||b.onDoubleClick(a))qa.is_passive||a.preventDefault(),a.defaultPrevented||(qa.is_passive=!0),a.stopPropagation()}function Ea(){U||(U=!0,document.addEventListener("touchmove",aa),document.addEventListener("touchend",ba),document.addEventListener("touchcancel",
ba))}function aa(a){if(1===a.touches.length){a.stopPropagation();var b=D(a.touches[0]);a=d(b.x,b.y);var c=a.x-x,e=a.y-y;0!==c&&0!==e&&Ga();x=a.x;y=a.y;t(c,e)}else if(2===a.touches.length){T=!0;var n=a.touches[0];b=a.touches[1];c=Fa(n,b);e=1+(c/pa-1)*Pa;n=D(n);b=D(b);x=(n.x+b.x)/2;y=(n.y+b.y)/2;C&&(b=S(),x=b.x,y=b.y);Z(x,y,e);pa=c;a.stopPropagation();aa.is_passive||a.preventDefault();a.defaultPrevented||(aa.is_passive=!0)}}function ba(a){if(0<a.touches.length)a=D(a.touches[0]),a=d(a.x,a.y),x=a.x,y=
a.y;else{var b=new Date;300>b-Ha&&(C?(a=S(),ca(a.x,a.y,ra)):ca(oa.x,oa.y,ra));Ha=b;U=!1;ma();T&&Ia();Ca()}}function Fa(a,b){var c=a.clientX-b.clientX;a=a.clientY-b.clientY;return Math.sqrt(c*c+a*a)}function xa(a){qa(a);a=D(a);C&&(a=S());ca(a.x,a.y,ra)}function wa(a){if(!Qa(a)){if(U)return a.stopPropagation(),!1;if(1===a.button&&null!==window.event||0===a.button){B.cancel();var b=D(a);b=d(b.x,b.y);x=b.x;y=b.y;document.addEventListener("mousemove",Ja);document.addEventListener("mouseup",Ka);la.capture(a.target||
a.srcElement);return!1}}}function Ja(a){if(!U){Ga();a=D(a);a=d(a.x,a.y);var b=a.x-x,c=a.y-y;x=a.x;y=a.y;t(b,c)}}function Ka(){la.release();ma();Ba()}function Ba(){document.removeEventListener("mousemove",Ja);document.removeEventListener("mouseup",Ka);V=!1}function Ca(){document.removeEventListener("touchmove",aa);document.removeEventListener("touchend",ba);document.removeEventListener("touchcancel",ba);T=V=!1}function Y(a){if(!Ra(a)){B.cancel();var b=a.deltaY;0<a.deltaMode&&(b*=100);b=Da(b);if(1!==
b){var c=C?S():D(a);Z(c.x,c.y,b);Y.is_passive||a.preventDefault();a.defaultPrevented||(Y.is_passive=!0)}}}function D(a){var b=q.getBoundingClientRect();return{x:a.clientX-b.left,y:a.clientY-b.top}}function ca(a,b,c){var e=h.scale,f={scale:e};c={scale:c*e};B.cancel();X();W=v(f,c,{step:function(c){ja(a,b,c.scale)},done:Ia})}function S(){var a=q.getBoundingClientRect();return{x:a.width*C.x,y:a.height*C.y}}function Z(a,b,c){B.cancel();X();return ua(a,b,c)}function X(){W&&(W.cancel(),W=null)}function Da(a){return 1-
Math.sign(a)*Math.min(.25,Math.abs(sa*a/128))}function Ga(){V||(K("panstart"),V=!0,B.start())}function ma(){V&&(T||B.stop(),K("panend"))}function Ia(){ia=!1;K("zoomend");if(b.onZoomend)b.onZoomend()}function K(a){da.fire(a,da)}b=b||{};var u=b.controller;u||(a instanceof SVGElement&&(u=H(a,b)),a instanceof HTMLElement&&(u=E(a,b)));if(!u)throw Error("Cannot create panzoom for the current type of dom element");var q=u.getOwner(),N={x:0,y:0},ha=!1,h=new M;u.initTransform&&u.initTransform(h);var Oa="function"===
typeof b.filterKey?b.filterKey:c,Pa="number"===typeof b.pinchSpeed?b.pinchSpeed:1,O=b.bounds,R="number"===typeof b.maxZoom?b.maxZoom:Number.POSITIVE_INFINITY,L="number"===typeof b.minZoom?b.minZoom:0,P="number"===typeof b.boundsPadding?b.boundsPadding:.05,ra="number"===typeof b.zoomDoubleClickSpeed?b.zoomDoubleClickSpeed:1.75,Ra=b.beforeWheel||c,Qa=b.beforeMouseDown||c,sa="number"===typeof b.zoomSpeed?b.zoomSpeed:1,C=f(b.transformOrigin),la=b.enableTextSelection?k:G;m(O);b.autocenter&&g();var Q,Ha=
0,oa,U=!1,V=!1,x,y,pa;var B="smoothScroll"in b&&!b.smoothScroll?{start:c,stop:c,cancel:c}:I(l,Na,b.smoothScroll);var ka,W,T,ea=!1,ia=!1;va();var da={dispose:function(){Aa()},moveBy:t,moveTo:r,centerOn:function(a){var b=a.ownerSVGElement;if(!b)throw Error("ui element is required to be within the scene");var c=a.getBoundingClientRect();a=c.left+c.width/2;c=c.top+c.height/2;b=b.getBoundingClientRect();t(b.width/2-a,b.height/2-c,!0)},zoomTo:Z,zoomAbs:ja,smoothZoom:ca,smoothZoomAbs:function(a,b,c){var e=
{scale:h.scale};c={scale:c};B.cancel();X();W=v(e,c,{step:function(c){ja(a,b,c.scale)}})},showRectangle:function(a){var b=q.getBoundingClientRect();b=d(b.width,b.height);var c=a.right-a.left,e=a.bottom-a.top;if(!Number.isFinite(c)||!Number.isFinite(e))throw Error("Invalid rectangle");var f=Math.min(b.x/c,b.y/e);h.x=-(a.left+c/2)*f+b.x/2;h.y=-(a.top+e/2)*f+b.y/2;h.scale=f},pause:function(){Aa();ea=!0},resume:function(){ea&&(va(),ea=!1)},isPaused:function(){return ea},getTransform:function(){return h},
getMinZoom:function(){return L},setMinZoom:function(a){L=a},getMaxZoom:function(){return R},setMaxZoom:function(a){R=a},getTransformOrigin:function(){return C},setTransformOrigin:function(a){C=f(a)},getZoomSpeed:function(){return sa},setZoomSpeed:function(a){if(!Number.isFinite(a))throw Error("Zoom speed should be a number");sa=a}};La(da);return da}function f(a){if(a){if("object"===typeof a)return Number.isFinite(a.x)&&Number.isFinite(a.y)||l(a),a;l()}}function l(a){console.error(a);throw Error('Cannot parse transform origin.\nSome good examples:\n  "center center" can be achieved with {x: 0.5, y: 0.5}\n  "top center" can be achieved with {x: 0.5, y: 0}\n  "bottom right" can be achieved with {x: 1, y: 1}');
}function c(){}function m(a){var b=typeof a;if("undefined"!==b&&"boolean"!==b&&!(Number.isFinite(a.left)&&Number.isFinite(a.top)&&Number.isFinite(a.bottom)&&Number.isFinite(a.right)))throw Error("Bounds object is not valid. It can be: undefined, boolean (true|false) or an object {left, top, right, bottom}");}function e(a){return Number.isNaN?Number.isNaN(a):a!==a}var p=a("wheel"),v=a("amator"),La=a("ngraph.events"),I=a("./lib/kinetic.js");g=a("./lib/createTextSelectionInterceptor.js");var G=g(),k=
g(!0),M=a("./lib/transform.js"),H=a("./lib/svgController.js"),E=a("./lib/domController.js");d.exports=b;(function(){function a(){var c=document.querySelector(g);if(c){for(var f=e.attributes,d={},v=0;v<f.length;++v){var k=f[v];if(k.name&&"p"===k.name[0]&&"z"===k.name[1]&&"-"===k.name[2]){var p=k.name.substr(3);k=JSON.parse(k.value);p={name:p,value:k}}else p=void 0;p&&(d[p.name]=p.value)}console.log(d);window[l]=b(c,d)}else 2E3>Date.now()-m?setTimeout(a,100):console.error("Cannot find the panzoom element",
l)}if("undefined"!==typeof document){var c=document.getElementsByTagName("script");if(c){for(var e,f=0;f<c.length;++f){var d=c[f];if(d.src&&d.src.match(/\bpanzoom(\.min)?\.js/)){e=d;break}}if(e){var g=e.getAttribute("query");if(g){var l=e.getAttribute("name")||"pz",m=Date.now();a()}}}}})()},{"./lib/createTextSelectionInterceptor.js":2,"./lib/domController.js":3,"./lib/kinetic.js":4,"./lib/svgController.js":5,"./lib/transform.js":6,amator:7,"ngraph.events":9,wheel:10}],2:[function(a,d,g){function b(a){a.stopPropagation();
return!1}function f(){}d.exports=function(a){if(a)return{capture:f,release:f};var c,d,e,g=!1;return{capture:function(a){g=!0;d=window.document.onselectstart;e=window.document.ondragstart;window.document.onselectstart=b;c=a;c.ondragstart=b},release:function(){g&&(g=!1,window.document.onselectstart=d,c&&(c.ondragstart=e))}}}},{}],3:[function(a,d,g){d.exports=function(a,f){if(!(a instanceof HTMLElement))throw Error("svg element is required for svg.panzoom to work");var b=a.parentElement;if(!b)throw Error("Do not apply panzoom to the detached DOM element. ");
a.scrollTop=0;f.disableKeyboardInteraction||b.setAttribute("tabindex",0);return{getBBox:function(){return{left:0,top:0,width:a.clientWidth,height:a.clientHeight}},getOwner:function(){return b},applyTransform:function(b){a.style.transformOrigin="0 0 0";b="matrix3d("+b.scale+", 0, 0, 0, 0, "+b.scale+", 0, 0, 0, 0, 1, 0, "+b.x+", "+b.y+", 0, 1)";a.style.transform=b;a.style.webkitTransform=b;a.style.MozTransform=b;a.style.msTransform=b;a.style.OTransform=b}}}},{}],4:[function(a,d,g){(function(a){function b(){return"function"===
typeof a.requestAnimationFrame?a.requestAnimationFrame:function(a){return setTimeout(a,16)}}d.exports=function(f,c,d){function e(){var a=Date.now(),b=a-H;H=a;var c=f();a=c.x-M.x;var d=c.y-M.y;M=c;b=1E3/(1+b);r=.8*a*b+.2*r;w=.8*d*b+.2*w;E=k(e)}function g(){var a=Date.now()-H,b=!1,e=0,d=0;z&&(e=-z*Math.exp(-a/342),.5<e||-.5>e?b=!0:e=z=0);J&&(d=-J*Math.exp(-a/342),.5<d||-.5>d?b=!0:d=J=0);b&&(c(t+e,F+d),A=k(g))}"object"!==typeof d&&(d={});var l="number"===typeof d.minVelocity?d.minVelocity:5,m="number"===
typeof d.amplitude?d.amplitude:.25;var I="function"===typeof d.cancelAnimationFrame?d.cancelAnimationFrame:"function"===typeof a.cancelAnimationFrame?a.cancelAnimationFrame:clearTimeout;var G=I,k="function"===typeof d.requestAnimationFrame?d.requestAnimationFrame:b(),M,H,E,r,t,z,w,F,J,A;return{start:function(){M=f();z=J=r=w=0;H=new Date;G(E);G(A);E=k(e)},stop:function(){G(E);G(A);var a=f();t=a.x;F=a.y;H=Date.now();if(r<-l||r>l)z=m*r,t+=z;if(w<-l||w>l)J=m*w,F+=J;A=k(g)},cancel:function(){G(E);G(A)}}}}).call(this,
