...
}e=g[c]={exports:{}};d[c][0].call(e.exports,function(a){return f(d[c][1][a]||a)},e,e.exports,a,d,g,b)}return g[c].exports}for(var l="function"==typeof require&&require,c=0;c<b.length;c++)f(b[c]);return f}return a}()({1:[function(a,d,g){function b(a,b){function d(a,b){if(u.getScreenCTM){var n=u.getScreenCTM(),c=n.d,e=n.f;N.x=a*n.a-n.e;N.y=b*c-e}else N.x=a,N.y=b;return N}function g(){var a,b=0,c=0;if(a=ra()){b=a.left;c=a.top;var e=a.right-a.left;a=a.bottom-a.top}else a=q.getBoundingClientRect(),e=a.width,
a=a.height;var f=u.getBBox();if(0!==f.width&&0!==f.height){var d=Math.min(e/f.width,a/f.height);h.x=-(f.left+f.width/2)*d+e/2+b;h.y=-(f.top+f.height/2)*d+a/2+c;h.scale=d}}function l(){return{x:h.x,y:h.y}}function r(a,b){h.x=a;h.y=b;A();K("pan");fa()}function A(){var a=ra();if(a){var b=!1;var c=u.getBBox();var e=c.left*h.scale+h.x,f=c.top*h.scale+h.y;var d=c.width*h.scale+e;c=c.height*h.scale+f;d=a.left-d;0<d&&(h.x+=d,b=!0);d=a.right-e;0>d&&(h.x+=d,b=!0);d=a.top-c;0<d&&(h.y+=d,b=!0);d=a.bottom-f;0>
d&&(h.y+=d,b=!0);return b}}function ra(){if(O){if("boolean"===typeof O){var a=q.getBoundingClientRect(),b=a.width;a=a.height;return{left:b*P,top:a*P,right:b*(1-P),bottom:a*(1-P)}}return O}}function fa(){ha=!0;Q=window.requestAnimationFrame(Ja)}function sa(a,b,c){if(e(a)||e(b)||e(c))throw Error("zoom requires valid numbers");var n=h.scale*c;if(n<L){if(h.scale===L)return;c=L/h.scale}if(n>R){if(h.scale===R)return;c=R/h.scale}a=d(a,b);h.x=a.x-c*(a.x-h.x);h.y=a.y-c*(a.y-h.y);O&&1===P&&1===L?(h.scale*=
c,A()):A()||(h.scale*=c);K("zoom");fa()}function ia(a,b,c){sa(a,b,c/h.scale)}function t(a,b,c){if(c){ja&&ja.cancel();var n=0,e=0;ja=v({x:0,y:0},{x:a,y:b},{step:function(a){r(h.x+(a.x-n),h.y+(a.y-e));n=a.x;e=a.y}})}else r(h.x+a,h.y+b)}function Ka(a,b){W();r(a,b)}function ta(){q.addEventListener("mousedown",ua,{passive:!1});q.addEventListener("dblclick",va,{passive:!1});q.addEventListener("touchstart",wa,{passive:!1});q.addEventListener("keydown",xa,{passive:!1});p.addWheelListener(q,X,{passive:!1});
fa()}function ya(){p.removeWheelListener(q,X);q.removeEventListener("mousedown",ua);q.removeEventListener("keydown",xa);q.removeEventListener("dblclick",va);q.removeEventListener("touchstart",wa);Q&&(window.cancelAnimationFrame(Q),Q=0);B.cancel();za();Aa();ka.release();la()}function Ja(){ha&&(ha=!1,u.applyTransform(h),K("transform"),Q=0)}function xa(a){var b=0,c=0,n=0;if(38===a.keyCode)c=1;else if(40===a.keyCode)c=-1;else if(37===a.keyCode)b=1;else if(39===a.keyCode)b=-1;else if(189===a.keyCode||
109===a.keyCode)n=1;else if(187===a.keyCode||107===a.keyCode)n=-1;if(!La(a,b,c,n)){if(b||c)onKeyDefault.is_passive||a.preventDefault(),a.defaultPrevented||(onKeyDefault.is_passive=!0),a.stopPropagation(),a=q.getBoundingClientRect(),a=Math.min(a.width,a.height),t(.05*a*b,.05*a*c);n&&(b=Ba(100*n),C?c=S():(c=q.getBoundingClientRect(),c={x:c.width/2,y:c.height/2}),a=c,Y(a.x,a.y,b))}}function wa(a){b.onTouch&&b.onTouch(a);1===a.touches.length?(ma=a=D(a.touches[0]),a=d(a.x,a.y),x=a.x,y=a.y,B.cancel(),Ca()):
2===a.touches.length&&(na=Da(a.touches[0],a.touches[1]),Z=!0,Ca())}function oa(a){if(!b.onDoubleClick||b.onDoubleClick(a))oa.is_passive||a.preventDefault(),a.defaultPrevented||(oa.is_passive=!0),a.stopPropagation()}function Ca(){T||(T=!0,document.addEventListener("touchmove",aa),document.addEventListener("touchend",ba),document.addEventListener("touchcancel",ba))}function aa(a){if(1===a.touches.length){a.stopPropagation();var b=D(a.touches[0]);a=d(b.x,b.y);var c=a.x-x,e=a.y-y;0!==c&&0!==e&&Ea();x=
a.x;y=a.y;t(c,e)}else if(2===a.touches.length){Z=!0;var n=a.touches[0];b=a.touches[1];c=Da(n,b);e=1+(c/na-1)*Ma;n=D(n);b=D(b);x=(n.x+b.x)/2;y=(n.y+b.y)/2;C&&(b=S(),x=b.x,y=b.y);Y(x,y,e);na=c;a.stopPropagation();aa.is_passive||a.preventDefault();a.defaultPrevented||(aa.is_passive=!0)}}function ba(a){if(0<a.touches.length)a=D(a.touches[0]),a=d(a.x,a.y),x=a.x,y=a.y;else{var b=new Date;300>b-Fa&&(C?(a=S(),ca(a.x,a.y,pa)):ca(ma.x,ma.y,pa));Fa=b;T=!1;la();Aa()}}function Da(a,b){var c=a.clientX-b.clientX;
a=a.clientY-b.clientY;return Math.sqrt(c*c+a*a)}function va(a){oa(a);a=D(a);C&&(a=S());ca(a.x,a.y,pa)}function ua(a){if(!Na(a)){if(T)return a.stopPropagation(),!1;if(1===a.button&&null!==window.event||0===a.button){B.cancel();var b=D(a);b=d(b.x,b.y);x=b.x;y=b.y;document.addEventListener("mousemove",Ga);document.addEventListener("mouseup",Ha);ka.capture(a.target||a.srcElement);return!1}}}function Ga(a){if(!T){Ea();a=D(a);a=d(a.x,a.y);var b=a.x-x,c=a.y-y;x=a.x;y=a.y;t(b,c)}}function Ha(){ka.release();
la();za()}function za(){document.removeEventListener("mousemove",Ga);document.removeEventListener("mouseup",Ha);U=!1}function Aa(){document.removeEventListener("touchmove",aa);document.removeEventListener("touchend",ba);document.removeEventListener("touchcancel",ba);Z=U=!1}function X(a){if(!Oa(a)){B.cancel();var b=a.deltaY;0<a.deltaMode&&(b*=100);b=Ba(b);if(1!==b){var c=C?S():D(a);Y(c.x,c.y,b);X.is_passive||a.preventDefault();a.defaultPrevented||(X.is_passive=!0)}}}function D(a){var b=q.getBoundingClientRect();
return{x:a.clientX-b.left,y:a.clientY-b.top}}function ca(a,b,c){var e=h.scale,d={scale:e};c={scale:c*e};B.cancel();W();V=v(d,c,{step:function(c){ia(a,b,c.scale)},done:Pa})}function S(){var a=q.getBoundingClientRect();return{x:a.width*C.x,y:a.height*C.y}}function Y(a,b,c){B.cancel();W();return sa(a,b,c)}function W(){V&&(V.cancel(),V=null)}function Ba(a){return 1-Math.sign(a)*Math.min(.25,Math.abs(qa*a/128))}function Ea(){U||(K("panstart"),U=!0,B.start())}function la(){U&&(Z||B.stop(),K("panend"))}
function Pa(){K("zoomend")}function K(a){da.fire(a,da)}b=b||{};var u=b.controller;u||(a instanceof SVGElement&&(u=H(a,b)),a instanceof HTMLElement&&(u=E(a,b)));if(!u)throw Error("Cannot create panzoom for the current type of dom element");var q=u.getOwner(),N={x:0,y:0},ha=!1,h=new M;u.initTransform&&u.initTransform(h);var La="function"===typeof b.filterKey?b.filterKey:c,Ma="number"===typeof b.pinchSpeed?b.pinchSpeed:1,O=b.bounds,R="number"===typeof b.maxZoom?b.maxZoom:Number.POSITIVE_INFINITY,L="number"===
typeof b.minZoom?b.minZoom:0,P="number"===typeof b.boundsPadding?b.boundsPadding:.05,pa="number"===typeof b.zoomDoubleClickSpeed?b.zoomDoubleClickSpeed:1.75,Oa=b.beforeWheel||c,Na=b.beforeMouseDown||c,qa="number"===typeof b.zoomSpeed?b.zoomSpeed:1,C=f(b.transformOrigin),ka=b.enableTextSelection?k:G;m(O);b.autocenter&&g();var Q,Fa=0,ma,T=!1,U=!1,x,y,na;var B="smoothScroll"in b&&!b.smoothScroll?{start:c,stop:c,cancel:c}:I(l,Ka,b.smoothScroll);var ja,V,Z,ea=!1;ta();var da={dispose:function(){ya()},moveBy:t,
moveTo:r,centerOn:function(a){var b=a.ownerSVGElement;if(!b)throw Error("ui element is required to be within the scene");var c=a.getBoundingClientRect();a=c.left+c.width/2;c=c.top+c.height/2;b=b.getBoundingClientRect();t(b.width/2-a,b.height/2-c,!0)},zoomTo:Y,zoomAbs:ia,smoothZoom:ca,smoothZoomAbs:function(a,b,c){var e={scale:h.scale};c={scale:c};B.cancel();W();V=v(e,c,{step:function(c){ia(a,b,c.scale)}})},showRectangle:function(a){var b=q.getBoundingClientRect();b=d(b.width,b.height);var c=a.right-
a.left,e=a.bottom-a.top;if(!Number.isFinite(c)||!Number.isFinite(e))throw Error("Invalid rectangle");var f=Math.min(b.x/c,b.y/e);h.x=-(a.left+c/2)*f+b.x/2;h.y=-(a.top+e/2)*f+b.y/2;h.scale=f},pause:function(){ya();ea=!0},resume:function(){ea&&(ta(),ea=!1)},isPaused:function(){return ea},getTransform:function(){return h},getMinZoom:function(){return L},setMinZoom:function(a){L=a},getMaxZoom:function(){return R},setMaxZoom:function(a){R=a},getTransformOrigin:function(){return C},setTransformOrigin:function(a){C=
f(a)},getZoomSpeed:function(){return qa},setZoomSpeed:function(a){if(!Number.isFinite(a))throw Error("Zoom speed should be a number");qa=a}};Ia(da);return da}function f(a){if(a){if("object"===typeof a)return Number.isFinite(a.x)&&Number.isFinite(a.y)||l(a),a;l()}}function l(a){console.error(a);throw Error('Cannot parse transform origin.\nSome good examples:\n  "center center" can be achieved with {x: 0.5, y: 0.5}\n  "top center" can be achieved with {x: 0.5, y: 0}\n  "bottom right" can be achieved with {x: 1, y: 1}');
}function c(){}function m(a){var b=typeof a;if("undefined"!==b&&"boolean"!==b&&!(Number.isFinite(a.left)&&Number.isFinite(a.top)&&Number.isFinite(a.bottom)&&Number.isFinite(a.right)))throw Error("Bounds object is not valid. It can be: undefined, boolean (true|false) or an object {left, top, right, bottom}");}function e(a){return Number.isNaN?Number.isNaN(a):a!==a}var p=a("wheel"),v=a("amator"),Ia=a("ngraph.events"),I=a("./lib/kinetic.js");g=a("./lib/createTextSelectionInterceptor.js");var G=g(),k=
...
a.scrollTop=0;d.disableKeyboardInteraction||b.setAttribute("tabindex",0);return{getBBox:function(){return{left:0,top:0,width:a.clientWidth,height:a.clientHeight}},getOwner:function(){return b},applyTransform:function(b){a.style.transformOrigin="0 0 0";a.style.transform="matrix("+b.scale+", 0, 0, "+b.scale+", "+b.x+", "+b.y+")"}}}},{}],4:[function(a,d,g){(function(a){function b(){return"function"===typeof a.requestAnimationFrame?a.requestAnimationFrame:function(a){return setTimeout(a,16)}}d.exports=
function(d,c,f){function e(){var a=Date.now(),b=a-H;H=a;var c=d();a=c.x-M.x;var f=c.y-M.y;M=c;b=1E3/(1+b);r=.8*a*b+.2*r;w=.8*f*b+.2*w;E=k(e)}function g(){var a=Date.now()-H,b=!1,e=0,d=0;z&&(e=-z*Math.exp(-a/342),.5<e||-.5>e?b=!0:e=z=0);J&&(d=-J*Math.exp(-a/342),.5<d||-.5>d?b=!0:d=J=0);b&&(c(t+e,F+d),A=k(g))}"object"!==typeof f&&(f={});var l="number"===typeof f.minVelocity?f.minVelocity:5,m="number"===typeof f.amplitude?f.amplitude:.25;var I="function"===typeof f.cancelAnimationFrame?f.cancelAnimationFrame:
"function"===typeof a.cancelAnimationFrame?a.cancelAnimationFrame:clearTimeout;var G=I,k="function"===typeof f.requestAnimationFrame?f.requestAnimationFrame:b(),M,H,E,r,t,z,w,F,J,A;return{start:function(){M=d();z=J=r=w=0;H=new Date;G(E);G(A);E=k(e)},stop:function(){G(E);G(A);var a=d();t=a.x;F=a.y;H=Date.now();if(r<-l||r>l)z=m*r,t+=z;if(w<-l||w>l)J=m*w,F+=J;A=k(g)},cancel:function(){G(E);G(A)}}}}).call(this,"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?
window:{})},{}],5:[function(a,d,g){d.exports=function(a,d){if(!(a instanceof SVGElement))throw Error("svg element is required for svg.panzoom to work");var b=a.ownerSVGElement;if(!b)throw Error("Do not apply panzoom to the root <svg> element. Use its child instead (e.g. <g></g>). As of March 2016 only FireFox supported transform on the root element");d.disableKeyboardInteraction||b.setAttribute("tabindex",0);return{getBBox:function(){var b=a.getBBox();return{left:b.x,top:b.y,width:b.width,height:b.height}},
getScreenCTM:function(){var a=b.getCTM();return a?a:b.getScreenCTM()},getOwner:function(){return b},applyTransform:function(b){a.setAttribute("transform","matrix("+b.scale+" 0 0 "+b.scale+" "+b.x+" "+b.y+")")},initTransform:function(c){var d=a.getCTM();c.x=d.e;c.y=d.f;c.scale=d.a;b.removeAttributeNS(null,"viewBox")}}}},{}],6:[function(a,d,g){d.exports=function(){this.y=this.x=0;this.scale=1}},{}],7:[function(a,d,g){function b(){}function f(a){if(!a)return"undefined"!==typeof window&&window.requestAnimationFrame?
{next:window.requestAnimationFrame.bind(window),cancel:window.cancelAnimationFrame.bind(window)}:l();if("function"!==typeof a.next)throw Error("Scheduler is supposed to have next(cb) function");if("function"!==typeof a.cancel)throw Error("Scheduler is supposed to have cancel(handle) function");return a}function l(){return{next:function(a){return setTimeout(a,1E3/60)},cancel:function(a){return clearTimeout(a)}}}function c(){function a(a){d.add(a);f||(f=requestAnimationFrame(b))}function b(){f=0;var a=
d;d=c;c=a;c.forEach(function(a){a()});c.clear()}var c=new Set,d=new Set,f=0;return{next:a,cancel:a,clearAll:function(){c.clear();d.clear();cancelAnimationFrame(f);f=0}}}a=a("bezier-easing");var m={ease:a(.25,.1,.25,1),easeIn:a(.42,0,1,1),easeOut:a(0,0,.58,1),easeInOut:a(.42,0,.58,1),linear:a(0,0,1,1)};d.exports=function(a,c,d){function e(){var b=p(w/z);w+=1;g(b);w<=z?(F=r.next(e),v(a)):(F=0,setTimeout(function(){E(a)},0))}function g(b){t.forEach(function(c){a[c]=k[c]*b+l[c]})}var l=Object.create(null),
k=Object.create(null);d=d||{};var p="function"===typeof d.easing?d.easing:m[d.easing];p||(d.easing&&console.warn("Unknown easing function in amator: "+d.easing),p=m.ease);var v="function"===typeof d.step?d.step:b,E="function"===typeof d.done?d.done:b,r=f(d.scheduler),t=Object.keys(c);t.forEach(function(b){l[b]=a[b];k[b]=c[b]-a[b]});var z=Math.max(1,.06*("number"===typeof d.duration?d.duration:400)),w=0;var F=r.next(e);return{cancel:function(){r.cancel(F);F=0}}};d.exports.makeAggregateRaf=c;d.exports.sharedScheduler=
c()},{"bezier-easing":8}],8:[function(a,d,g){function b(a,b,d){return(((1-3*d+3*b)*a+(3*d-6*b))*a+3*b)*a}function f(a){return a}var l="function"===typeof Float32Array;d.exports=function(a,d,e,g){if(!(0<=a&&1>=a&&0<=e&&1>=e))throw Error("bezier x values must be in [0, 1] range");if(a===d&&e===g)return f;for(var c=l?new Float32Array(11):Array(11),m=0;11>m;++m)c[m]=b(.1*m,a,e);return function(f){if(0===f)return 0;if(1===f)return 1;for(var l=0,k=1;10!==k&&c[k]<=f;++k)l+=.1;--k;k=l+(f-c[k])/(c[k+1]-c[k])*
.1;var m=3*(1-3*e+3*a)*k*k+2*(3*e-6*a)*k+3*a;if(.001<=m){for(l=0;4>l;++l){m=3*(1-3*e+3*a)*k*k+2*(3*e-6*a)*k+3*a;if(0===m)break;var p=b(k,a,e)-f;k-=p/m}f=k}else if(0===m)f=k;else{k=l;l+=.1;var v=0;do p=k+(l-k)/2,m=b(p,a,e)-f,0<m?l=p:k=p;while(1E-7<Math.abs(m)&&10>++v);f=p}return b(f,d,g)}}},{}],9:[function(a,d,g){function b(a){var b=Object.create(null);return{on:function(c,d,e){if("function"!==typeof d)throw Error("callback is expected to be a function");var f=b[c];f||(f=b[c]=[]);f.push({callback:d,
