				...
				function(require, module, exports) {
					...
					function createPanZoom(domElement, options) {
						...
						function onKeyDown(e) {
							...
							if (x || y) {
								if (!onKeyDefault.is_passive)
									e.preventDefault();
								if (!e.defaultPrevented)
									onKeyDefault.is_passive = true;
						...
						function beforeDoubleClick(e) {
							...
							if (!beforeDoubleClick.is_passive)
								e.preventDefault();
							if (!e.defaultPrevented)
								beforeDoubleClick.is_passive = true;
							e.stopPropagation();
						}
						...
						function handleTouchMove(e) {
							if (e.touches.length === 1) {
								...
								e.stopPropagation();
								if (!handleTouchMove.is_passive)
									e.preventDefault();
								if (!e.defaultPrevented)
									handleTouchMove.is_passive = true;
							}
						}
						...
						function onMouseWheel(e) {
							...
							if (scaleMultiplier !== 1) {
								...
								if (!onMouseWheel.is_passive)
									e.preventDefault();
								if (!e.defaultPrevented)
									onMouseWheel.is_passive = true;
							}
						}
					...
					function autoRun() {
						...
						function collectOptions(script) {
							...
							for (var i = 0; i < attrs.length; ++i) {
								var attr = attrs[i];
								var nameValue = getPanzoomAttributeNameValue(
									attr
								);
								if (nameValue) {
					...
					(function(global) {
						...
						function kinetic(getPoint, scroll, settings) {
							...
							var cancelAnimationFrame =
								typeof settings.cancelAnimationFrame ===
								"function"
									? settings.cancelAnimationFrame
									: getCancelAnimationFrame();
							var requestAnimationFrame =
								typeof settings.requestAnimationFrame ===
								"function"
							...
							function autoScroll() {
								...
								if (ax) {
									dx =
										-ax * Math.exp(-elapsed / timeConstant);
								...
								if (ay) {
									dy =
										-ay * Math.exp(-elapsed / timeConstant);
